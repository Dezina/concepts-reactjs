...
function Jobs() {
    ...
    const applyjob = (job) => {
        ...
        axios.post(`http://localhost:5000/jobsapplied/upload`, formData)
            .then(
                (response) => {
                                ...
                                results && results.map((row, index) => (
                                    ...
                                    <details key={index}>
                                        ...
                                        <div>
                                            ...
                                            />
                                            <button onClick={() => applyjob(row)} className="btn btn-primary float-end">Apply</button>
                                        </div>
                                    </details>
                                ))
                            }
